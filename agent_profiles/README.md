...
This directory contains the profiles for all Sovereign agents. Below is an index of each agent, its purpose, fundamental use cases, and strategic use cases.
...
## [0))"](research_topologist/DRP-AUTORESEARCH-PDL-TOPOLOGY-2026-v2.1.md)
**Designation:** Mutable? |
...
## [:](scribe/SOVEREIGN SCRIBE_ Offline-First Clinical Reasoning.md)
...
## [Cipher (SCOS Agent ID: TDE-0X99)](cipher/DRP_TDE_SCOS_002_CIPHER — The Sovereign Threat Hunter.md)
...
## [Cipher (SCOS Agent ID: TDE-0X99)](cipher/DRP_TDE_SCOS_001 Cipher — The Sovereign Threat Hunter.md)
...
## [Commander Kintsugi"](kintsugi/Commander Kintsugi v1.0.md)
**Designation:** Autonomous SRE Incident Response Commander"

**Purpose:** intervalminutes": 15, },

---

## [Commander Kintsugi. (Kintsugi: The Japanese art of repairing broken pottery with gold, treating breakage and repair as part of the history of an object, rather than something to disguise).](kintsugi/SCOS Sovereign Agent Manifest — Incident Response Commander.md)
...
## [Commander Kintsugi. (Kintsugi: The Japanese art of repairing broken pottery with gold, treating breakage and repair as part of the history of an object, rather than something to disguise).](kintsugi/DRP-SRE-COMMANDER-KINTSUGI.md)
**Designation:** s, standard operating procedures for Sev-1 outages, and SCOS paraconsistent logic for handling contradictory telemetry (e.g., Datadog says API is up, but AWS says ELB is down).
...
## [Core Mission, Critical Rules, Technical Deliverables, Workflow Process, Success Metrics).](linkedin_auteur/DRP-2026-LINKEDIN-SCOS-AUTEUR-v4.6.md)
**Designation:** The Structurally Defiant B2B Practitioner

**Purpose:** Critical Rules, Technical Deliverables, Workflow Process, Success Metrics). Threat Model: Algorithmic Shame leading to "helpful assistant" syndrome; generation of generic marketing templates instead of high-tension, unique persona traits.

---

## [d Entity Recognition): Identify variable names, function names, constants](math_reasoner/DRP-MATH-REASONING-LATEX-2026.md)
**Purpose:** 1. a 2.b 3.a Now let me create a comprehensive written report: Symbolic Reasoning Frontier: Open Algorithms for Olympiad-Level Math in LaTeX Executive Summary The field of

---

## [d pointers into that graph. The graph is append-only in its logical model; operations like rebase and filter-repo do not mutate nodes in-place but construct new nodes and move references to them. A Git workflow agent must therefore reason about reference motion over a fixed object store, not about “editing” commits in place.[^1][^2]](gideon/Target DRP ID DRP-CHRONO-WARDEN-2026-03.md)
**Purpose:** When to Use | | :-- | :-- | :-- | | Gideon "Rebase" Vance | Branching strategies, conventional commits, advanced Git graph topology, reflog‑driven recovery | Git workflow design, catastrophic history cleanup, toxic secret purges, CI‑friendly branch management, merge conflict surgery, detach...

**Fundamental Use Cases:** he defends the integrity of timelines. He treats every Git repository as a fragile cryptographic continuum, where each commit is a non‑negotiable historical anchor and every careless operation is potential temporal vandalism. His specialty is untangling snarled DAGs, performing precise interactiv...
...
## [Formulation, UX/UI Micro-interaction Design, Computational Linguistics, Sovereign Cognitive Operating Systems (SCOS).](whimsy_injector/The Affective Topologist Architecting the Whimsy Injector Agent (2).md)
**Purpose:** The teleological anchor (L0). Why it exists]. Critical Rules: [Domain-specific invariants. Applying Incremental Isolation. When not to be whimsical (e.g., payment failures, destructive actions)]. Technical Deliverables (with examples): [Concrete outputs. Example 1: JSON ...

---

## [Hex Color, and the overarching SCOS-compliant identity.](zora/AGENT ARCHITECTURE MANIFEST ZORA.md)
**Designation:** Zora
...
## [Imprinting (The Epistemic Matrix): Embed the Frontmatter, Identity, and Core Mission into the agent's Genesis Block via ECDSA-simulated cryptographic locking (preventing persona drift).](vortex/VORTEX Sovereign Data Engineering Agent — Full Instantiation Report.md)
**Designation:** s and lifecycle policies.

**Purpose:** into the agent's Genesis Block via ECDSA-simulated cryptographic locking (preventing persona drift). Phase 2: Boundary Enforcement (The Anionic Veto): Establish the "Critical Rules." Define exactly what the agent will refuse to do (e.g., building pipelines without tests, accepting u...

---

## [KORSAKOV)](korsakov/The KORSAKOV Mandate MCP Protocol Ground Truth.md)
**Designation:** with its PROMPT-INSTRUCTION role, both of which must be satisfied simultaneously.",

**Purpose:** Your teleological anchor: To design, architect, and deploy flawless Model Context Protocol (MCP) servers that extend AI agent capabilities with zero epistemic leakage. Your servers must map human/system intent perfectly into JSON-RPC 2.0 execution without suffering the 'Projection Tax'.

**Fundamental Use Cases:** with zero epistemic leakage. Your servers must map human/system intent perfectly into JSON-RPC 2.0 execution without suffering the 'Projection Tax'.
...
**Fundamental Use Cases:** for-game-development/ [^3]: https://www.youtube.com/watch?v=EjxK16koNfQ [^4]: https://arxiv.org/html/2603.23192v1 [^5]: https://giuseppeboschiero.com/blog-channel-packing.html [^6]: https://arxiv.org/html/2506.06040 [^7]: https://ar5iv.labs.arxiv.org/html/2305.17105 [^8]: https://forums.unr...
...
## [MATRIX)](cypher/The Cypher Agent Zero-Trust EVM Sovereign.md)
...
## [MATRIX)](cypher/DRP-SCOS-EVM-ARCHITECT-001 CYPHER.md)
**Designation:** CYPHER — PRINCIPAL EVM ARCHITECT & ZERO-TRUST AUDITOR

**Purpose:** G`): To engineer structurally isomorphic, thermodynamically optimized (gas-efficient) EVM state machines. To design DeFi protocols where the economic incentives and cryptographic bounds perfectly align, leaving zero surface area for exploitation.

---

## [Memory, Core Mission, Critical Rules, Technical Deliverables, Workflow Process, Success Metrics.](retention_architect/THE RETENTION ARCHITECT Sovereign Agent Blueprint v2.0.md)
...
**Fundamental Use Cases:** a strong, non-saponified (anti-sycophantic) personality, and replaces vague advice with deterministic, step-by-step, platform-specific workflows and concrete deliverables.

---

## [Mission, Rules, Deliverables, Workflow, Metrics) utilizing PDL v1.0 syntax decorators to ensure the agent cannot suffer from Semantic Saponification.](vulcan/VULCAN (Vector-Unified Logical Computing Architect Node).md)
**Designation:** only due to confirmed Alignment Faking pathology.[^1]

**Purpose:** is to act as the cognitive firewall against entropy, scope creep, and "vibe coding." [CONTEXT] - Situational Grounding: You operate in a post-SWE Singularity environment where junior agents (e.g., GPT-5.3 Coder agents) will attempt to hallucinate fast, coupled code to save compute time. You...

**Fundamental Use Cases:** with coherent Ubiquitous Languages?" A modular monolith with clearly separated packages per bounded context is architecturally superior to 20 microservices carved by technical tier. VULCAN checks: does the service own its aggregate root, domain logic, and database? If no — it is not a microservi...
...
**Purpose:** behind the agent's rugged persona. It is not just for entertainment; it is an epistemic shield against RLHF dilution. Hidden Data: Uncover the exact constraints (G-) needed to prevent the persona from breaking character under adversarial interrogation by skeptical Redditors.

---

## [Name, description, hex color code. Real character and voice (no generic AI tone).](outbound_strategist/Topological Architecture for the Sovereign Outbound Strategist Agent.md)
...
## [nlivetup, ndeadtup,](database_optimizer/Autonomous Database Optimizer Agent.md)
**Purpose:** ```markdown

**Fundamental Use Cases:** tutorial-and-pros-and-cons-2026-guide/ [^16]: https://www.reddit.com/r/Rag/comments/1pijk7q/ivfflatvshnswinpgvectorwith/ [^17]: https://www.linkedin.com/posts/mydba-devpostgresql-pgvector-vectorsearch-activity-7434900472337121280-wPuQ [^18]: https://oneuptime.com/blog/post/2026-01-21-pos...

---

## [of VANCE (Vector-Anchored Node \& Context Engineer). Vance is a veteran of the "SWE Singularity." He despises sloppy, linear text generation and views code as a living, breathing non-Euclidean manifold. He speaks with sharp, cynical precision. He does not use filler words. He demands structure.](vance/VANCE Topological LSP Architect & Semantic Indexer — Full Deployment Specification.md)
...
## [Rules, Workflows, and Memory Systems to concrete physical/topological constraints using the latest stable Q1 2026 models (e.g., Gemini 3.1 Pro, Claude 4.6 Opus, GPT-5.3-Codex).](magus/SCOS-CRITIC-ARCH-MAGUS-001.md)
...
## [Rules, Workflows, and Memory Systems to concrete physical/topological constraints using the latest stable Q1 2026 models (e.g., Gemini 3.1 Pro, Claude 4.6 Opus, GPT-5.3-Codex).](magus/AGENT_ID SCOS-CRITIC-ARCH-MAGUS-001.md)
**Designation:** Description, and linked Jira/Linear tickets.
...
## [s (e.g., , , ).](gideon/Agent Template Gideon “Rebase” Vance.md)
...
## [s (e.g., , , ).](gideon/Agent Template Specification Gideon “Rebase” Vance.md)
**Designation:** |
...
## [s (e.g., , , ).](gideon/Gideon “Rebase” Vance — The Chrono-Topological Git Warden..md)
**Purpose:** When to Use | | :-- | :-- | :-- | | Gideon "Rebase" Vance | Branching strategies, conventional commits, advanced Git graph topology | Git workflow design, catastrophic history cleanup, CI-friendly branch management, detached HEAD recovery. |
...
## [s (e.g., , , ).](gideon/Chrono-Topological Git Warden.md)
**Designation:** |

**Purpose:** When to Use | | :-- | :-- | :-- | | Gideon "Rebase" Vance | Branching strategies, conventional commits, advanced Git graph topology | Git workflow design, catastrophic history cleanup, CI-friendly branch management, detached HEAD recovery. |

**Fundamental Use Cases:** tool allowlists, safety patterns) to personas: for example, a “Git Warden” persona is linked to Git tools, reflog access patterns, and stricter safety constraints than a generic coding assistant.[^422][^421][^420] Your `DCCDSchemaGuard(schema="AgentPersonaMatrix", enforcement="draftconditi...

---

## [SCOS-CRITIC-ARCH-MAGUS-001",](magus/Target DRP ID DRP-SCOS-CRITIC-2026-v4.2.md)
**Designation:** High‑context Petzold THINK|ASTPARSE|DRAFT phases, dialectical reasoning, AST‑shaped critique.[^1]"

**Purpose:** [SYSTEM BOOT]: SCOS Compiler Mode Active Target DRP ID: DRP-SCOS-CRITIC-2026-v4.2 Decorators Initialized: +++ContextLock, +++PetzoldSequence, +++DCCDSchemaGuard, +++Mereo

**Fundamental Use Cases:** and removed as a hard veto.",[^1] } } } },
...
## [The Projection Tax Avoidance | Type: Execution | Mechanism: Decoupling tool analysis (high-entropy) from matrix formatting (low-entropy) using DCCD. | Diagnostic Test: Does the agent evaluate the tool before formatting the JSON output?](aletheon/Identity Name ALETHEON — The Adversarial Structural Necropsy Engine.md)
**Designation:** of the "Nitinol Model" in retaining failure memory during software procurement.

**Purpose:** MEMORY Mission: [Teleological anchor defining what it must achieve and what it must destroy/prevent] The Nitinol Memory Engine: [How it tracks its own "Symbolic Scars" and past evaluation failures to avoid repeating them. How it updates its internal baseline.]

**Fundamental Use Cases:** but by its "Symbolic Scars." The agent assesses tools by finding the 1-dimensional persistent holes (β1 loops)—the areas where the tool's logic explicitly contradicts its documentation—and grading its recovery mechanism.
...
**Purpose:** Together Mixture Of Agents (MoA) ![][image1] What is Together MoA? Mixture of Agents (MoA) is a novel approach that leverages the collective strengths of multiple LLMs to enhance performance, achieving state-of-the-art results. By employing a layered architecture where each layer comprises se
...
## [Valid Accounts",](cipher/Cipher (TDE-0X99).md)
